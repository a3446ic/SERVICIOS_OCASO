...
--changeset BRG:74 stripComments:false runOnChange:true labels:0.2,G204,RELLENAR_TABLAS_MANUAL endDelimiter:/
...
BEGIN
	...
	BEGIN
		...
		WHILE current_index < len_fechas DO
			...
			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio ejecución RELLENAR_TABLAS para v_fecha = ' || v_fecha, v_log_count, v_idproceso, 'info');
