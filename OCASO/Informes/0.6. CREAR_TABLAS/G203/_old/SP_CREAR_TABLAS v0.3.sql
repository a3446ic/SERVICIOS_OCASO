...
BEGIN
	...
	-- uso de variables de tabla si es posible
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_TABLA_IRPF creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_TABLA_PERCEPCIONES creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		IF v_periodo_posteado = 0 THEN
			...
			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio modificacion EXT.TEST_CARTERA_DDEE si ya no es derechos economicos.', v_log_count, v_idproceso, 'debug');
			...
			WHERE COMPENSATIONDATE = :v_startdate_cartera
				AND POSITIONNAME NOT IN :TBL_POSITIONS_CARTERA
				AND ESTADO = 'C'
			...
			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Fin modificacion EXT.TEST_CARTERA_DDEE si ya no es derechos economicos. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_TXN_MES creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_CREDITOS_MES creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_MEDIDAS_MES creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_PAGOS_MES creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_OFICINAS_MES creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_AGENTES_MES creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'TBL_AGENTES_PRIN_MES creada. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
	...
	------------------------------------------------------------------------------------------------------------------------------------
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio Borrado TEST_OUT_JERARQUIA_REP', v_log_count, v_idproceso, 'debug');

		DELETE EXT.TEST_OUT_JERARQUIA_REP WHERE PERIODSEQ = :i_PeriodSeq;

		v_num_rows := ::ROWCOUNT;

		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Fin Borrado TEST_OUT_JERARQUIA_REP. Filas borradas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');

		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio Carga TEST_OUT_JERARQUIA_REP', v_log_count, v_idproceso, 'debug');

		SELECT IFNULL(MAX(POS_ANT.EFFECTIVEENDDATE), MIN(POS_ACT.EFFECTIVESTARTDATE)) INTO v_fec_alta_cat_ins
		...
		INSERT INTO EXT.TEST_OUT_JERARQUIA_REP
			SELECT
				...
				:v_fec_alta_cat_ins AS FEC_ALTA_CAT_INS
		...
		CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Fin Carga TEST_OUT_JERARQUIA_REP. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');
		...
		IF :i_lista_informes = 'PEAG' OR :i_lista_informes LIKE '%,PEAG,%' OR :i_lista_informes LIKE '%,PEAG'
			...
			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio Borrado TEST_OUT_PERC_AGENTES_REP', v_log_count, v_idproceso, 'debug');

			DELETE EXT.TEST_OUT_PERC_AGENTES_REP WHERE PERIODSEQ = :i_PeriodSeq;

			v_num_rows := ::ROWCOUNT;

			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Fin Borrado TEST_OUT_PERC_AGENTES_REP. Filas borradas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');

			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio Carga TEST_OUT_PERC_AGENTES_REP. Percepciones.', v_log_count, v_idproceso, 'debug');
			...
			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Fin Carga TEST_OUT_PERC_AGENTES_REP. Percepciones. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');

			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio Carga TEST_OUT_PERC_AGENTES_REP. Percepciones DDEE.', v_log_count, v_idproceso, 'debug');
			...
			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Fin Carga TEST_OUT_PERC_AGENTES_REP. Percepciones DDEE. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');

			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio Carga TEST_OUT_PERC_AGENTES_REP. Balances.', v_log_count, v_idproceso, 'debug');
			...
			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Fin Carga TEST_OUT_PERC_AGENTES_REP. Balances. Filas: ' || v_num_rows, v_log_count, v_idproceso, 'debug');

			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Inicio actualización de fecha en OUT_FECHAS_WEBI_REP', v_log_count, v_idproceso, 'debug');

			CALL EXT.LIB_CREAR_TABLAS:UPDATE_FECHAS_WEBI(i_PeriodSeq, 'TEST_OUT_PERC_AGENTES_REP');

			CALL LIB_GLOBAL:WRITE_LOG (v_permisos_log, proc_name, 'Fin actualización de fecha en OUT_FECHAS_WEBI_REP', v_log_count, v_idproceso, 'debug');
