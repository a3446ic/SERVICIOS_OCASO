...
/*---------------------------------------------------------------------
	...
	|			3.3 	BRG/DTB	20251110	Eliminado '' de ESTRUCTURA_COMERCIAL
...
BEGIN
	...
	DECLARE v_version VARCHAR(10) := '3.5';
...
--		END IF; --LLS 20251110: comentado
        --FIN informe S4 RAPPEL PRODUCCIÓN AGENTES RESUMEN (RPA) --todos los meses
		------------------------------------------------------------------------------------------------------------------------		
