CREATE PROCEDURE EXT.SP_STAGE_ASEG_EMI_EA_RRTT (IN i_file_name varchar(120))
LANGUAGE SQLSCRIPT 
...
USING SQLSCRIPT_STRING AS LIBRARY;
	...
	BEGIN
		...
		CALL ext.lib_global:SP_insertaStageAsegurados (v_permisos_log, proc_name , 'EXT.PRESTAGE_ASEG_EMI_EA_RRTT', i_file_name ,v_log_count, v_idproceso);
