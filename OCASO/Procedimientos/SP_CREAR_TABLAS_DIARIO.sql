...
/*---------------------------------------------------------------------
	...
	| Version: 0.4	BRG	20260416	Añadido i_tipo a NULL en la llamada a SP_CREAR_TABLAS
	|
    -----------------------------------------------------------------------
*/
...
BEGIN
	...
	BEGIN
		...
		CALL EXT.SP_CREAR_TABLAS(v_periodseq, v_listado_informes, v_idproceso, NULL, v_log_count);
