CREATE PROCEDURE EXT.SP_STAGE_RECI_COB_OC_SERCO_RRTT (IN i_file_name varchar(120))
LANGUAGE SQLSCRIPT 
...
/*---------------------------------------------------------------------
    ...
    | y que mueve los datos de la tabla PRESTAGE_RECI_COB_OC_SERCO_RRTT a STAGE_RECIBOS
	|
...
BEGIN
	...
	BEGIN
		...
		CALL ext.lib_global:SP_insertaStageSerco (v_permisos_log, proc_name , 'EXT.PRESTAGE_RECI_COB_OC_SERCO_RRTT', i_file_name ,v_log_count, v_idproceso);
