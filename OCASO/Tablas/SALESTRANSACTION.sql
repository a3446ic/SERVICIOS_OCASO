CREATE COLUMN TABLE "EXT"."SALESTRANSACTION"(
	...
	"STAGEPROCESSFLAG" SMALLINT CS_INT DEFAULT 0,
	...
	CONSTRAINT "SALESTRANSACTION1_CK1" CHECK (("GENERICBOOLEAN1" IN (0, 1))),
	CONSTRAINT "SALESTRANSACTION1_CK6" CHECK (("GENERICBOOLEAN6" IN (0, 1))),
	CONSTRAINT "SALESTRANSACTION1_CK4" CHECK (("GENERICBOOLEAN4" IN (0, 1))),
	CONSTRAINT "SALESTRANSACTION1_CK2" CHECK (("GENERICBOOLEAN2" IN (0, 1))),
	CONSTRAINT "SALESTRANSACTION1_CK5" CHECK (("GENERICBOOLEAN5" IN (0, 1))),
	CONSTRAINT "SALESTRANSACTION1_CK3" CHECK (("GENERICBOOLEAN3" IN (0, 1))),
	CONSTRAINT "SALESTRANSACTION1_CK7" CHECK ("BATCHNAME" <> ''),
	CONSTRAINT "SALESTRANSACTION1_CK8" CHECK ("ORDERID" <> ''),
	CONSTRAINT "SALESTRANSACTION1_CK9" CHECK ("EVENTTYPEID" <> ''),
	CONSTRAINT "SALESTRANSACTION1_CK10" CHECK ("UNITTYPEFORVALUE" <> ''),
	CONSTRAINT "SALESTRANSACTION1_CK11" CHECK ("COMPENSATIONDATE" <> '')
)
UNLOAD PRIORITY 5 AUTO MERGE;
CREATE UNIQUE INVERTED VALUE INDEX "SALESTRANSACTION_UN1" ON "EXT"."SALESTRANSACTION" ( "BATCHNAME", "ORDERID", "LINENUMBER", "SUBLINENUMBER", "EVENTTYPEID" );
